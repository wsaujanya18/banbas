...
const InquiryForm = ({ status, setStatus }: InquiryFormProps) => {
    ...
    if (status === 'success') {
        return (
            <div className={styles.messageContainer}>
                <p className={styles.successMessage}>We have received your enquiry, our reservations team will get back to you shortly.</p>
            </div>
        );
    }
    ...
    return (
        <>
            ...
            {status === 'loading' && (
                <div className={styles.messageContainer}>
                    <p className={styles.loadingMessage}>Sending Your Inquiry, Please Wait...</p>
                </div>
            )}
            {status === 'idle' && (
