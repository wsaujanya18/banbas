    ...
    <section className={styles.section} id="location">
        <div className={styles.content}>
            <div className={mainStyles.sectionEntireScreenContentAndImage}>
                ...
                >
                    <img src="/images/banbas_location.png" alt="Banbas Location" className={styles.image} />
                </motion.div>
                <motion.div
                ...
                >
                    <div className={mainStyles.contentText}>
                        ...
                        <motion.p
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 0.5 }}
                            viewport={{ margin: '-200px', once: true }}>15 minutes drive from the hustle bustle of Sauraha, and peacefully next to the exotic Chitwan National Park.</motion.p>
                    </div>
                    <motion.div
                        initial={{ opacity: 0, x: 100 }}
                        whileInView={{ opacity: 1, x: 0 }}
