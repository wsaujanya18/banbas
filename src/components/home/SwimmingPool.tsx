                ...
                <div className={styles.modal} onClick={closeModal}>
                    <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                        <iframe
                            width="100%"
                            height="100%"
                            src="https://www.youtube.com/embed/b2uouHJC4s8?autohide=1&fs=1&rel=0&hd=1&wmode=transparent&enablejsapi=1&html5=1&autoplay=1"
                            title="Sidhhartha Vilasa | banbas "
