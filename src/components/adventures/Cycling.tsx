            ...
            <div className={mainStyles.sectionEntireScreenContentAndImage}>
                <div className={mainStyles.subsectionHalfScreenContent}>
                    <div className={mainStyles.contentText}>
                        ...
                        viewport={{ margin: '-200px', once: true }}
                        >
                            After a day filled with diverse adventures, Cycling offers a peaceful space to feel the soothing estasy of the dipping sun rays gently grazing your skin</motion.p>
                    </div>
                </div>
                <motion.div 
                ...
                transition={{ duration: 0.5 }}
                >
                    <img src="/images/adventures_sundowner.jpeg" alt="Cycling" className={mainStyles.image}/>
                </motion.div>
            </div>
        </section>
    );
